import { ObservablePoint, Ticker, Rectangle, Container, Sprite, FederatedPointerEvent, isMobile } from 'pixi.js';
...
export class FancyButton extends Container
{
    ...
    {
        console.log('_________________________', views);
        ...
        if (defaultView)
        {
            ...
            console.log('this._views.default', this._views.default);
            if (this._views.default === undefined)
            {
                throw new Error(`View ${defaultView} not found`);
            }
