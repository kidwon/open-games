...
const _NineSliceSprite = class extends Container.Container {
  /**
  ...
  constructor(options) {
    ...
    const nineSliceGeometry = new NineSliceGeometry.NineSliceGeometry({
      width: texture.width,
...
class NineSlicePlane extends NineSliceSprite {
  constructor(options) {
    deprecation.deprecation("v8", "NineSlicePlane is deprecated. Use NineSliceSprite instead.");
    super(options);
  }
}
