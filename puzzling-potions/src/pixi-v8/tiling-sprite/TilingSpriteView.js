...
const _TilingSpriteView = class {
  constructor(options) {
    ...
    this.onRenderableUpdate = NOOP.NOOP;
    ...
    this.tileTransform = new Transform.Transform({ observer: this });
  }
  get bounds() {
    if (this.boundsDirty) {
      this.updateBounds();
...
exports.TilingSpriteView = TilingSpriteView;
//# sourceMappingURL=TilingSpriteView.js.map
