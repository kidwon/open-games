...
var createIdFromString = require('../../shared/createIdFromString.js');
...
class PipelineSystem {
  ...
  setStencilMode(stencilMode) {
    ...
    this.stencilState = GpuStencilModesToPixi.GpuStencilModesToPixi[stencilMode];
  }
  ...
  createPipeline(geometry, program, state, topology) {
    ...
    depthStencil = GpuStencilModesToPixi.GpuStencilModesToPixi[this.stencilMode];
    blendModes[0].writeMask = this.stencilMode === _const.STENCIL_MODES.RENDERING_MASK_ADD ? 0 : this.colorMask;
    const descriptor = {
  ...
  generateProgramKey(program) {
    ...
    program._layoutKey = createIdFromString.createIdFromString(bigKey, "program");
