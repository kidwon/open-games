...
var isRenderingToScreen = require('../shared/renderTarget/isRenderingToScreen.js');
var RenderTarget = require('../shared/renderTarget/RenderTarget.js');
var SystemRunner = require('../shared/system/SystemRunner.js');
var Texture = require('../shared/texture/Texture.js');
var getCanvasTexture = require('../shared/texture/utils/getCanvasTexture.js');
...
class GlRenderTargetSystem {
  constructor(renderer) {
    ...
    this.rootProjectionMatrix = new Matrix.Matrix();
  ...
  initRenderTarget(renderSurface) {
    ...
    } else if (renderSurface instanceof Texture.Texture) {
