...
class TextureLayout extends EventEmitter__default["default"] {
  constructor(options = {}) {
    super();
    this.uvs = { x0: 0, y0: 0, x1: 0, y1: 0, x2: 0, y2: 0, x3: 0, y3: 0 };
    this.frame = options.frame || new Rectangle.Rectangle(0, 0, 1, 1);
...
//# sourceMappingURL=TextureLayout.js.map
