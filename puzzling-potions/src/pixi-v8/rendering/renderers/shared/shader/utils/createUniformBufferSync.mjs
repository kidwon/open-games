import { WGSL_TO_STD40_SIZE } from './createUBOElements.mjs';
import { uniformBufferParsers } from './uniformBufferParsers.mjs';
...
export { generateUniformBufferSync };
//# sourceMappingURL=createUniformBufferSync.mjs.map
