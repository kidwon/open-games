...
var getRenderableBounds = require('../../scene/bounds/getRenderableBounds.js');
...
class FilterSystem {
  constructor(renderer) {
    ...
    this.globalFilterBindGroup = new BindGroup.BindGroup({});
  ...
  push(instruction) {
    ...
    if (instruction.renderables) {
      ...
      getGlobalBounds.getGlobalBounds(instruction.container, true, bounds);
    }
    if (filters.length === 0) {
