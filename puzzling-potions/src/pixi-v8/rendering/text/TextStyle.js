...
const _TextStyle = class extends EventEmitter__default["default"] {
  constructor(style = {}) {
    super();
  ...
  set fill(value) {
    ...
    this._fill = convertFillInputToFillStyle.convertFillInputToFillStyle(value, GraphicsContext.GraphicsContext.defaultFillStyle);
    this.update();
  }
  get stroke() {
