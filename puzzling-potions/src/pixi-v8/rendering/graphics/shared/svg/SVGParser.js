  ...
  if (style) {
    ...
    for (let i = 0; i < styleParts.length; i++) {
      ...
      switch (key) {
        case "stroke":
          if (value !== "none") {
            strokeStyle.color = convertColorToNumber.convertColorToNumber(value);
            useStroke = true;
          }
          break;
        case "stroke-width":
        ...
        case "fill":
          if (value !== "none") {
            useFill = true;
            fillStyle.color = convertColorToNumber.convertColorToNumber(value);
          }
          break;
        case "fill-opacity":
    ...
    if (stroke && stroke !== "none") {
      useStroke = true;
      strokeStyle.color = convertColorToNumber.convertColorToNumber(stroke);
      strokeStyle.width = parseFloatAttribute(svg, "stroke-width", 1);
    }
    const fill = svg.getAttribute("fill");
    if (fill && fill !== "none") {
      useFill = true;
      fillStyle.color = convertColorToNumber.convertColorToNumber(fill);
    }
  }
