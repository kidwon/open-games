...
var _const = require('../../rendering/renderers/shared/texture/const.js');
...
async function detectVideoAlphaMode() {
  promise ?? (promise = (async () => {
    ...
    if (!gl) {
      return _const.ALPHA_MODES.UNPACK;
    }
    ...
    return pixel[0] <= pixel[3] ? _const.ALPHA_MODES.PMA : _const.ALPHA_MODES.UNPACK;
  })());
  return promise;
}
